...
VAL_DIR = "data_3d/val"
SAVE_PATH = "checkpoints/unet3d_genesis_aug.pth"
CSV_LOG = "results_genesis_aug.csv"
PLOT_PATH = "training_curve_genesis_aug.png"
...
# === Ana Eğitim Döngüsü ===
def main():
    train_dataset = Lung3DDataset(TRAIN_DIR, augment=True)
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Score")
    plt.title("Validation Dice & IoU (Genesis Aug)")
    plt.legend()
    plt.grid(True)
    plt.savefig(PLOT_PATH, dpi=200)
    print(f"\n📈 Eğitim eğrisi kaydedildi: {PLOT_PATH}")

    # 1 örnek tahmin dağılımı
